    ...
    >
      ...
      >
        ...
        <div className='flex flex-col overflow-x-hidden overflow-y-auto p-4'>
          ...
          <div className='w-full bg-gray-200 p-2 truncate text-sm font-normal text-[#333] mb-3 flex-none rounded'>
            {QRData.name}
          </div>
          <button
            type='button'
            onClick={handleCopy}
            className='w-full p-2 h-10 text-sm font-normal rounded flex-none bg-2c5799 text-white transition-colors duration-300 mb-3'
          >
            Copiar código pix
          </button>
          <button
